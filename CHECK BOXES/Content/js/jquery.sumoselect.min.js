        ...
        var d = {
            ...
            if (!this.sumo && a(this).is("select")) {//already initialized
                var f = a.extend({}, d, b, a(this).data()); this.sumo = {
                    ...
                    }, selAllState: function selAllState() { var b = this; if (f.selectAll && b.is_multi) { var c = 0, d = 0; b.optDiv.find("li.opt").not(".hidden .disabled").each(function (b, f) { a(f).hasClass("selected") && c++, d++ }), c == d ? b.selAll.removeClass("partial").addClass("selected") : 0 === c ? b.selAll.removeClass("selected partial") : b.selAll.addClass("partial") } }, showOpts: function showOpts() {
                    ...
                    setText: function setText() {
                        var a = this; if (a.placeholder = "", a.is_multi) {
                        ...
                        } else a.placeholder = a.E.find(":checked").not(":disabled").text(); var b = !1; a.placeholder || (b = !0, a.placeholder = a.E.attr("placeholder"), !a.placeholder && (//if placeholder is there then set it
                        ...
                        var c = a.select.find("input.HEMANT123"); return c.length && c.val(a.getSelStr()), b ? a.caption.addClass("placeholder") : a.caption.removeClass("placeholder"), a.placeholder
